...
_DISEASE_KEYWORDS: list[tuple[list[str], str]] = [
    ...
    (['typhoid', 'paratyphoid', 'salmonella typhi', 'widal'], 'Typhoid and Paratyphoid Fever'),
    ...
    (['bloody diarrhea', 'dysentery', 'shigella'], 'Acute Bloody Diarrhea'),
    (['hfmd', 'hand, foot', 'hand foot', 'enterovirus', 'coxsackie'], 'Hand, Foot, and Mouth Disease'),
    (['covid', 'sars-cov-2', 'sars cov 2'], 'COVID-19'),
    ...
    (['avian influenza', 'h5n1', 'h7n9'], 'Human Avian Influenza'),
    (['mers'], 'Middle East Respiratory Syndrome'),
    (['sars', 'severe acute respiratory'], 'Severe Acute Respiratory Syndrome'),
    (['influenza-like', 'influenza like', ' ili '], 'Influenza-Like Illness'),
    (['tetanus neonatorum', 'neonatal tetanus'], 'Neonatal Tetanus'),
    (['tetanus'], 'Non-Neonatal Tetanus'),
    (['acute flaccid', 'poliomyelitis', 'polio'], 'Acute Flaccid Paralysis'),
    (['aefi', 'adverse event following'], 'Adverse Event Following Immunization'),
    (['shellfish', 'psp'], 'Paralytic Shellfish Poisoning'),
    (['encephalitis'], 'Acute Encephalitis Syndrome'),
    (['hemorrhagic fever'], 'Acute Hemorrhagic Fever Syndrome'),
    (['bacterial meningitis', 'pneumococcal meningitis'], 'Bacterial Meningitis'),
]
