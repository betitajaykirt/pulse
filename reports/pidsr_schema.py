...
# Conversational Hiligaynon / Taglish — UI display only. API keys stay snake_case.
PIDSR_SYMPTOM_LOCAL_LABELS: Dict[str, str] = {
    'body_malaise': 'Palangrehe / nagalain ang pakiramdam sang lawas',
    'drowsiness': 'Tuyo-tuyo / pahuwayon',
    'marked_weakness': 'Grabe nga kaluya',
    'chills': 'Naga-pangatog sa tugnaw',
    'extreme_tiredness': 'Kapoy kaayo / sobrang kaluya',
    'photophobia': 'Naga-sakit ang mata sa suga/inggat',
    'diaphoresis': 'Pwerte/sobra nga pamalhas',
    'fever': 'Hilanat / naga-hilanat',
    'chest_pain': 'Sakit ang dughan',
    'myalgia': 'Sakit ang muscles / palanglaban ang lawas',
    'right_upper_quadrant_pain': 'Sakit ang tiyan sa tuo nga bahin',
    'headache': 'Sakit ang ulo',
    'neck_stiffness': 'Naga-stiff / naga-pahiwi ang liog',
    'sore_muscles': 'Sakit / palamangkuha ang muscles',
    'joint_swelling': 'Naga-habok ang lutahan / joints',
    'reticular_pain': 'Sakit sa likod sang mata',
    'trismus': 'Naga-kudpa / indi mabuksan ang baba',
    'abdominal_colic': 'Naga-puyos / naga-krampas ang tiyan',
    'bloody_diarrhea': 'May dugo ang kalibanga',
    'diarrhea': 'Kalibanga / naga-laintian',
    'loose_watery_stool': 'Pwerte ka lasaw / tubigon nga tae',
    'pale_stools': 'Welga / putli o malapuyot nga tae',
    'thirst': 'Uhawon / naga-panga-uhaw',
    'abdominal_discomfort': 'Nagalain / hulas ang tiyan',
    'constipation': 'Nagalain pag-bawas / pigado mag-tae',
    'dry_moist_lips': 'Mala / namasa-masa nga bibig',
    'mucus_in_stool': 'May uling/sipon-sipon ang tae',
    'rice_water_stool': 'Daw hugas-gasang nga tae',
    'vomiting': 'Naga-suka',
    'anorexia': 'Nadulaan sang gana mag-kaon',
    'dark_urine': 'Maitum / madalom nga duag sang ihi',
    'hematemesis': 'Naga-suka sang dugo',
    'nausea': 'Naga-duhol / naga-kalasuka',
    'tenesmus': 'Sige-suka / daw gusto sige bawas apang wala naga-gwa',
    'post_tussive_vomiting': 'Naga-suka pagkatapos sang sige-sige nga ubo',
    'gum_bleeding': 'Naga-dugo ang ngipon / kagis',
    'easy_bruisability': 'Madasig mag-pasa / mag-mula ang panit',
    'injection_site_reaction': 'Naga-habok / naga-pula ang ginturu-ok',
    'koplik_spots': 'May puti-puti sa sulod sang baba',
    'rash': 'Pano sang palamulaan / rashes',
    'bull_neck': 'Naga-habok ang liog',
    'ecchymoses': 'Dako nga pasa sa panit',
    'itchy_skin': 'Katol ang panit',
    'painless_skin_lesion': 'May pilas sa panit nga wala naga-sakit',
    'vesicle_mouth_ulcers': 'May sugat-sugat / singaw sa baba',
    'conjunctival_suffusion': 'Naga-pula ang puti sang mata',
    'epistaxis_bleeding': 'Naga-dugo ang ilong (sugpon)',
    'jaundice': 'Naga-dalag ang mata kag panit',
    'petechiae': 'Bintik-bintik nga pula sa panit',
    'palmar_plantar_vesicles': 'May tubig-tubig nga rashes sa palad o tiil',
    'cough_paroxysms': 'Sige-sige nga ubo nga naga-huni',
    'loss_of_smell_taste': 'Nadulaan sang panabor o panimaho',
    'stridor': 'Naga-hurnog / naga-huni ang pag-ginhawa',
    'hemoptysis': 'Naga-ubo nga may dugo',
    'runny_nose': 'Naga-sipon',
    'trouble_breathing': 'Buda / mabudlay mag-ginhawa',
    'dry_cough': 'Mala nga ubo (walay plema)',
    'sore_throat': 'Sakit ang tutunlan',
    'trouble_swallowing': 'Mabudlay mag-tulon',
    'acute_flaccid_paralysis': 'Halamoot nga pagka-lumpo sang tiil o kamot',
    'inability_to_suck': 'Indi makadodo / makatuytoy ang bata',
    'seizure': 'Naga-kumpiskar / naga-kiskis',
    'altered_consciousness': 'Nagalain ang pamensaron',
    'muscle_spasms': 'Naga-tig-a ang muscles',
    'severe_restlessness': 'Pwerte ka gin-ang / sige-sige nga hiyab',
    'hydrophobia': 'Hadlok sa tubig',
    'tourniquet_test_positive': 'May naga-gwa nga palamulaan sa tourniquet test',
    'tingling_numbness': 'Naga-palanglagkit / naga-palamanud ang tiil o kamot',
    'animal_bite': 'Kagat o kalmot sang sapat',
    'has_animal_contact': 'Nakatandog o nakaupod sa ilaga, baboy, baka, o iro',
    'recent_immunization': 'May bakuna sa nagligad nga 4 ka simana',
    'unhygienic_cord_care': 'Indi matinlo nga pag-atiman sa pusod sang bata',
    'shellfish_ingestion': 'Nagkaon sang tahong, talaba, o seafood antes nagsakit',
    'has_known_community_cases': 'May nakaupod nga pareho sang balatian',
    'has_stagnant_water': 'May naga-pundok nga tubig o container sa palibot',
    'has_contaminated_food_water': 'Nag-inom sang tubig sa bubon/gripo o nagkaon sang street food',
    'poultry_exposure': 'Nakatandog sang manok o pispis',
    'has_livestock_wool_hides': 'Nakatandog sang balhibo o panit sang sapat',
    'has_recent_travel': 'Nagbyahe sa lugar nga may damo nga nagakasakit',
    'has_flood_exposure': 'Nagluwas / nagtalamak sa baha, suba, o kanal',
}
